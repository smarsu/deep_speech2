...
if __name__ == '__main__':
    ...
    if parse == 'train': 
        ...
        model.train(aishell, epoch=1000000, batch_size=16, lr=0.0001, params_path=None)
        ...
        # model.train(aishell, epoch=1000000, batch_size=16, lr=0.0001, weight_decay=0., params_path='data/deep_speech2-0.01-4-2.2333707728450722')  # 18
        ...
        model.value(aishell.train_datas(1, 'dev'), params_path='data/deep_speech2-0.01-4-2.2333707728450722')
    elif parse == 'test':
        root = '/share/datasets/data_aishell'
        aishell = datasets.Aishell(root)
        net = deep_speech2.DeepSpeech2(201, 4231)
